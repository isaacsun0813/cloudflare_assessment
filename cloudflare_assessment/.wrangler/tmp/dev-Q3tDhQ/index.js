// .wrangler/tmp/bundle-HwC1PO/checked-fetch.js
...
var src_default = {
  async fetch(request, env) {
    ...
    if (url.pathname === "/organization-chart") {
      const data = await env.KV_NAMESPACE.get("organizationChart", { type: "json" });
      if (!data) {
...
// .wrangler/tmp/bundle-HwC1PO/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-HwC1PO/middleware-loader.entry.ts
